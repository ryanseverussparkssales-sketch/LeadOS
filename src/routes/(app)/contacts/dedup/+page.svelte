						...
						{#each group as contact, i}
							<div class="flex items-center gap-3 rounded-lg border border-[#1e1e1e] p-3">
								<div class="flex-1">
									...
									<p class="text-xs text-[#7c7c7c]">{contact.company || '—'} · {contact.phone}</p>
								</div>
								{#if i > 0}
